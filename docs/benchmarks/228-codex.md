...
README의 [호출 그래프](228-calls.svg)는 관측 기록이 있는 Sol·Terra·Luna의 주문 여정을
보여준다. 세 모델 각각의 누적 호출이 같음을 확인한 뒤 두 방식의 선으로 표시하며 모델 간
합계나 평균이 아니다. Sonnet·Opus의 42회 → 7회는 원 PR의 보고값으로 따로 인용한다.
