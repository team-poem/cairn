...
- **다음 사이클(피벗 — #158 닫음, 디스커션 #168):** first-party 러너 중단(데스크탑 러너 범용화로 뷰어는
  ...
  **진행(2026-09-07):** 종결 = #199(PR #202) · #200(PR #201, `urlMatchesFrozen` 쿼리 부분집합 + `hasStablePath`
  ...
  #220은 PR #227로 다뤘으나 `Refs`라 이슈는 열려 있다(CI가 workspace/bench 테스트를 분리하고 PR마다
  단계별 재생 중앙값·패키지 크기를 base와 비교, 포크는 코멘트 미게시). #196·#175는 2.10.0. #184 advisory→fail-closed 전환은 #169 벤치 뒤; #169는 amazon의 "구조 수정 더 기다려야 하나" 질문에 "반대,
